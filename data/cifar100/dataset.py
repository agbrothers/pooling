...
def load_cifar_100(experiment_path, config):
    ...
    trainset = CIFAR100_KFOLD(root=path, train=True, transform=transform_train, test_transform=transform_test)
    testset = CIFAR100_KFOLD(root=path, train=False, transform=transform_test)
